...
/* Question 15: This query groups pitch types by mechanical stress (High-Torque Breaking vs. Low-Tension Off-speed) to demonstrate that while fastballs are the foundation of all repertoires, the frequency of breaking balls is the primary driver of TJS prevalence */
